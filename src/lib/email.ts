...
export async function sendRegistrationConfirmation(email: string, name: string) {
  return resend.emails.send({
    from: "NXTMUN <noreply@portal.nxtmun.com>",
    to: email,
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>For inquiries, please contact us at <a href="mailto:support@portal.nxtmun.com">support@portal.nxtmun.com</a></p>
            </div>
            <div class="footer">
              <p>NXTMUN Conference 2026</p>
            </div>
...
export async function sendReportEmail(reportData: any) {
  ...
  return resend.emails.send({
    from: "NXTMUN Reports <noreply@portal.nxtmun.com>",
