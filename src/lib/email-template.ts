...
const LOGO_URL = "https://portal.nxtmun.com/NXTMUN.png";
const SITE_URL = "https://portal.nxtmun.com";
const INSTAGRAM_URL = "https://www.instagram.com/NXTMUN.SA";
const CONTACT_EMAIL = "noreply@portal.nxtmun.com";
...
&nbsp;&middot;&nbsp;
<a href="${SITE_URL}" style="color:${TEXT_SECONDARY};text-decoration:underline;">portal.nxtmun.com</a>
</p>
