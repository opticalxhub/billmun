      ...
      <div className="max-w-4xl mx-auto py-20 px-8">
        ...
        <div className="space-y-12 text-text-secondary leading-relaxed text-sm">
          ...
          <section>
            ...
            <p>2.2. Contact Email: dpo@nxtmun.com</p>
          </section>
          ...
          <section>
            ...
            <p>10.2. If you wish to exercise any of the rights set out above, please contact our Data Protection Officer at dpo@nxtmun.com.</p>
