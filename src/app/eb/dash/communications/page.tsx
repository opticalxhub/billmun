...
const ROLES = ["DELEGATE", "CHAIR", "CO_CHAIR", "EXECUTIVE_BOARD"];
...
export default function CommunicationsPage() {
  ...
  const emailPreviewHtml = (() => {
    ...
    return `<!DOCTYPE html><html><head><meta charset="utf-8"/></head><body style="margin:0;padding:0;background:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#0a0a0a;"><tr><td align="center" style="padding:40px 20px;"><table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;"><tr><td align="center" style="padding:0 0 24px 0;"><img src="/NXTMUN.png" alt="NXTMUN" width="120" style="display:block;max-width:120px;filter:invert(1);"/></td></tr><tr><td style="padding:0 0 32px 0;"><div style="height:1px;background:#222;"></div></td></tr><tr><td style="padding:0 0 24px 0;"><h1 style="margin:0;font-size:22px;font-weight:700;color:#fff;letter-spacing:0.02em;">${sanitize(emailSubject || "Subject")}</h1></td></tr><tr><td style="padding:0 0 32px 0;"><p style="margin:0 0 16px 0;line-height:1.7;color:#fff;font-size:15px;">Dear [Recipient Name],</p>${bodyHtml}</td></tr><tr><td style="padding:0 0 24px 0;"><div style="height:1px;background:#222;"></div></td></tr><tr><td style="padding:0;"><p style="margin:0 0 8px 0;font-size:12px;color:#666;text-align:center;">© 2026 NXTMUN. All rights reserved.</p><p style="margin:0 0 8px 0;font-size:12px;color:#666;text-align:center;"><a href="https://instagram.com/portal.nxtmun.com" style="color:#999;text-decoration:underline;">Instagram</a> · <a href="https://portal.nxtmun.com" style="color:#999;text-decoration:underline;">portal.nxtmun.com</a></p><p style="margin:0;font-size:11px;color:#666;text-align:center;line-height:1.5;">This email was sent because you registered for NXTMUN.<br/>Contact <a href="mailto:pr@portal.nxtmun.com" style="color:#999;">pr@portal.nxtmun.com</a> if this was a mistake.</p></td></tr></table></td></tr></table></body></html>`;
  })();
