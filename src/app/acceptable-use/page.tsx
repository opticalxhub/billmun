      ...
      <div className="max-w-4xl mx-auto py-20 px-8">
        ...
        <div className="space-y-12 text-text-secondary leading-relaxed text-sm">
          ...
          <section>
            ...
            <p>11.1. If you encounter any behavior or content that you believe violates this Acceptable Use Policy, please report it immediately to our team at compliance@nxtmun.com or through the platform&apos;s reporting features. We take all reports seriously and will investigate them thoroughly.</p>
