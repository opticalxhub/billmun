      ...
      <div className="max-w-4xl mx-auto py-20 px-8">
        ...
        <div className="space-y-12 text-text-secondary leading-relaxed text-sm">
          <section>
            ...
            <p>1.1. This Acceptable Use Policy (AUP) is a binding legal agreement describing the rules and guidelines for your use of the NXTMUN platform, services, and associated technologies. Our goal is to ensure a safe, respectful, and productive environment for all delegates, organizers, and staff members. This AUP applies to all users, regardless of their role or relationship with the NXTMUN organization.</p>
          ...
          <section>
            ...
            <p>2.1. You may not use the NXTMUN platform for any activity that is illegal, harmful, or interferes with the operation of our services. These prohibitions include, but are not limited to:</p>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Attacks on Systems:</strong> Engaging in any activity that disrupts, impairs, or otherwise interferes with the NXTMUN platform, its servers, or networks, including denial-of-service (DoS) attacks.</li>
              <li><strong>Unauthorized Access:</strong> Attempting to gain unauthorized access to any portion of the platform, other accounts, computer systems, or networks connected to any NXTMUN server through hacking, password mining, or any other means.</li>
          ...
          <section>
            ...
            <p>3.1. NXTMUN is an educational platform dedicated to diplomacy and professional discourse. Users must adhere to high standards of communication. The following types of content and communication are strictly prohibited:</p>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Defamatory Material:</strong> Posting or sharing any information that is false and intended to harm the reputation of another individual or the NXTMUN organization.</li>
              ...
              <li><strong>Misrepresentation:</strong> Impersonating any person or entity, including any NXTMUN employee or representative, or falsely stating or otherwise misrepresenting your affiliation with a person or entity.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Scraping and Data Extraction:</strong> Unauthorized harvesting or collection of any data, including user emails, profile information, or conference materials for use outside the NXTMUN ecosystem.</li>
          ...
          <section>
            ...
            <p>5.1. The use of NXTMUN&apos;s communication tools for any purpose other than MUN-related activity is prohibited. This includes:</p>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Commercial Advertising:</strong> Promoting products, services, or events not officially sanctioned or hosted by NXTMUN.</li>
          ...
          <section>
            ...
            <p>6.1. NXTMUN reserves the right, but does not have the obligation, to monitor usage of the platform to ensure compliance with this AUP. We may use automated tools or manual review to identify violations.</p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Permanently terminating your NXTMUN account and barring you from future conferences.</li>
          ...
          <section>
            ...
            <p>9.1. NXTMUN shall not be held liable for any damages, losses, or legal costs incurred by a user as a result of a violation of this AUP by another user. Each user is solely responsible for their own actions and communications on the platform.</p>
            <p>9.2. You agree to indemnify and hold NXTMUN and its organizers harmless from any claims, damages, liabilities, and expenses (including legal fees) arising out of your violation of this AUP.</p>
          </section>
          ...
          <section>
            ...
            <p>11.1. If you encounter any behavior or content that you believe violates this Acceptable Use Policy, please report it immediately to our team at compliance@portal.nxtmun.com or through the platform&apos;s reporting features. We take all reports seriously and will investigate them thoroughly.</p>
          ...
          <div className="pt-12 border-t border-white/10 space-y-4">
            ...
            <p className="text-xs italic">All rights reserved to NXTMUN Organization.</p>
          </div>
        </div>
      </div>
      <Footer />
